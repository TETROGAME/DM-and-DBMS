...
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON),
  CONSTRAINT [passport_id_check] CHECK (passport_id LIKE '[A-Z][A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9]')
)
GO
...
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON),
  ...
  CONSTRAINT [plate_number_check] CHECK (plate_number LIKE '[0-9][0-9][0-9][0-9] [A-Z][A-Z]-[0-9]')
)
GO
